    ...
    <div className="pt-16 min-h-screen bg-[var(--primary)] text-[var(--text-primary)]">
      ...
      {/* Nuestros Valores */}
        <section className="p-10 bg-[#ffb733] text-white">
          <h1 className="text-3xl font-semibold text-center mb-8 text-[var(--primary)]">
            Nuestros Valores
          </h1>
            ...
            {values.map((value, index) => {
              ...
              return (
                <div
                  ...
                  className={`cursor-pointer rounded-lg p-6 shadow-md transition-all duration-300 ${
                    isOpen
                      ? "bg-white text-[var(--primary)]"
                      : "bg-[var(--primary)] text-white hover:bg-white hover:text-[var(--primary)]"
                  }`}
                >
